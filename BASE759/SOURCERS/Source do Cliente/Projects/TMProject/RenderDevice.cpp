...
float RenderDevice::r_fWidthRatio = 1.0f;
float RenderDevice::r_fHeightRatio = 1.0f;
...
RenderDevice::RenderDevice(DWORD dwScreenWidth, DWORD dwScreenHeight, DWORD dwBitCount, int bFullScreen)
{
	...
	RenderDevice::r_fWidthRatio = (float)m_dwScreenWidth / 800.0f;
	RenderDevice::r_fHeightRatio = (float)m_dwScreenHeight / 600.0f;

	RenderDevice::m_fWidthRatio = (float)m_dwScreenWidth / 1366.0f;
	RenderDevice::m_fHeightRatio = (float)m_dwScreenHeight / 768.0f;

	if ((float)m_dwScreenWidth == 800 || (float)m_dwScreenWidth == 640 || (float)m_dwScreenWidth == 1024 || (float)m_dwScreenWidth == 1280) {
