...
{
    if ((dwServerTime - m_dwGolemDustTime) > 3000)
    {
        auto pSpChange = new TMSkillSpChangeWing({ m_vecPosition.x, m_fHeight, m_vecPosition.y }, 0, this);

        auto pSpChange1 = new TMSkillSpChangeWing({ m_vecPosition.x, m_fHeight, m_vecPosition.y }, 1, this);
