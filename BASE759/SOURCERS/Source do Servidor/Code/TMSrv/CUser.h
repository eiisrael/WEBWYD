...
public:
	...
	//cod aposta pvp 
	unsigned char Aposta;
	unsigned char ApostaWinner;
	unsigned char ApostaStart;
	unsigned char Apostakb;
	unsigned char ApostaWinnerkb;
	unsigned char ApostaStartkb;
	unsigned char BattleWinner;
	unsigned char BattleChall;
	//cod aposta pvp 
